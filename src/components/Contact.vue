<template>
  <div class="mx-5 page-fade-in mt-10">          
        <div>
          <img 
            src="../assets/images/mo-dj.jpg"
            alt="Mo Jiwa DJ"
            :class="this.$store.state.theme === 'Dark' ? 'border-gray-300' : 'border-gray-900'"
            class="ml-1/4 md:ml-0 w-3/6 sm:w-64 sm:h-auto border-solid border-2 rounded-md md:border-4 my-image" />
        </div>                
        <div class="md:flex justify-between w-3/4">   
          <div>
            <div class="md:flex md:text-2xl text-xl mt-4 mb-2">
              <label>Business(ish)</label>
            </div>
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://github.com/mojiwa">GitHub: mojiwa</a></label>
            </div>
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://twitter.com/timetraveller_x">Twitter: timetraveller_x</a></label>              
            </div>                  
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/in/mjiwa/">LinkedIn: mjiwa</a></label>              
            </div>
            <div class="flex ml-2 mb-8 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://instagram.com/mojiwa">Instagram: mojiwa</a></label>            
            </div>         
          </div>       

          <div>              
            <div class="lg:text-2xl text-xl mt-4 mb-2">
            ...
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://instagram.com/djmojiwa">Instagram: djmojiwa</a></label>            
            </div>    
            <div class="flex ml-2 mb-8 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://facebook.com/djmojiwa">Facebook: djmojiwa</a></label>            
            </div>   
          </div>
          <div>
            <div class="lg:text-2xl text-xl mt-4 mb-2">
            ...
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://open.spotify.com/user/mojiwa">Spotify: mojiwa</a></label>            
            </div>  
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://steamcommunity.com/id/mojiwa/">Steam: mojiwa</a></label>            
            </div>   
            <div class="flex ml-2 mb-4 slide-right">
              ...
              <label class="ml-4 social-media-text"><a target="_blank" rel="noopener noreferrer" href="https://www.gog.com/u/mojiwa">GOG: mojiwa</a></label>            
            </div>   
            <div class="flex ml-2 mb-4 slide-right">
              <svg               
                class="social-media-buttons"
              ...
              <label class="ml-4 social-media-text hover:text-teal-600">BattleTag: MoJiwa#1643</label>            
            </div>   
          </div>  
        </div>
      </div>
