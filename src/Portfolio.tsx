  ...
  render() {
    return(
      <div className='mx-5 page-fade-in'>
        <div className='mb-6'>
          <div>
            <a href={'https://github.com/mojiwa/mojiwa.com'} target='_blank' rel="noopener noreferrer"><span onClick={() => this.slideElement('mojiwa')} className='w-auto text-2xl mb-8 cursor-pointer hover:text-teal-600 transition-colors ease-in-out duration-500'>mojiwa.com <br/>(opens on GitHub)</span></a>                    
          </div>
        </div>
        <div className='mb-2'>
          <div className='flex hover:text-teal-600 cursor-pointer transition-colors ease-in-out duration-500' onClick={() => this.slideElement('library')}>
            <span className='text-2xl mb-8'>Library</span>
        ...
        <div className='mb-2'>
          <div className='flex hover:text-teal-600 cursor-pointer transition-colors ease-in-out duration-500' onClick={() => this.slideElement('tagbot')}>
              <span className='text-2xl mb-8'>TagBot</span>
          ...
          <div id='tagbot' className='slide-up'>                
            ...
            <a href={'images/tagbot2.png'} target='_blank' rel="noopener noreferrer">
              <img 
                ...
                className={`${this.props.Theme === Theme.Dark ? 'border-gray-300' : 'border-gray-900'} cursor-zoom-in border-gray-300 border-solid border-2 rounded-md md:border-4`} />
            </a>
          </div>
        </div>        
        <div className='mb-6'>
