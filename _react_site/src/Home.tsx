...
export default class Home extends React.PureComponent<IHomeProps, {}> {
    ...
    render() {
        return(
            <div id='home-page'>           
                <div className={`w-full p-2 font-thin center-content text-center cursor-default`} >
                    <span className='text-4xl md:text-5xl'>Hi, I'm <span className='font-normal text-teal-600'>Mo Jiwa</span>.</span>
                    <br />
                    <span className='text-2xl md:text-3xl'>I'm a full-stack web and software developer</span>
                    <div>
                        <Link to='/about'>
                            <button      
                                ...
                                className={`see-more-button mt-4 focus:outline-none font-thin text-xl md:text-2xl rounded-lg pt-1 pb-1 pl-4 pr-4 hover:bg-teal-600 border-solid border-2 hover:text-gray-300 hover:border-teal-600 ${this.props.Theme === Theme.Dark ? 'text-gray-300 border-gray-300' : 'text-gray-900 border-gray-900'}`}>
